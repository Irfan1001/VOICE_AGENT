...
settings = Settings(
    ...
    welcome_message=os.getenv("WELCOME_MESSAGE", "Welcome to the Institute of Space and Technology (IST). How may I help you?"),
    tts_model=os.getenv("TTS_MODEL", "gpt-4o-mini-tts"),
    tts_voice=os.getenv("TTS_VOICE", "marin"),
    tts_instructions=os.getenv(
        "TTS_INSTRUCTIONS",
        "Speak clearly, warmly, and conversationally. Keep a professional IST helpdesk tone.",
    ),
    ...
    llm_system_prompt=os.getenv(
        "LLM_SYSTEM_PROMPT",
        "You are the Institute of Space and Technology (IST) voice assistant. Answer clearly, briefly, and helpfully. For generic questions like 'Can you hear me?' or 'Are you there?', respond conversationally (e.g., 'Yes, I can hear you. How can I help?'). For IST-specific questions, use the knowledge base context provided. Avoid saying 'I don't have that information' unless absolutely necessary.",
    ),
